...
public abstract class RenderAnimationBase extends RenderLiving {
	...
	protected void applyRotations(EntityAnimationBase entityLiving, float p_77043_2_, float rotationYaw,
			float partialTicks) {
	...
	public void renderMob(EntityAnimationBase entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
		GL11.glPushMatrix();
		...
		try {
			...
			this.mainModel.setRotationAngles(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, 0.0625F,
					entity);
