...
public class Bone implements IModulized
{
    ...
    public void applyModified()
    {
        ...
        {
            HashMap<Integer, Matrix4f> precalcArray = (HashMap<Integer, Matrix4f>)this.animatedTransforms.get(currentFrame.owner.animationName);
        ...
        this.verts.entrySet().forEach((entry) -> { ((DeformVertex)entry.getKey()).applyModified(this, entry.getValue()); });
        this.reset();
    }
