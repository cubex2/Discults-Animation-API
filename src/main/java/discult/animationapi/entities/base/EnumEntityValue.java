...
public enum EnumEntityValue {
   x(RotationData.x, false),
   y(RotationData.y, false),
   z(RotationData.z, false),
   pitch(RotationData.x, true),
   yaw(RotationData.y, true),
   headPitch(RotationData.x, true),
   headYaw(RotationData.y, true);
